...
public class IOSVP {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                switch (seccion) {
                    ...
                    case 3: // Tripulantes
                        ...
                        if (campos[0].equals("C")) cEmp.hireConductorForEmpresa(Rut.of(campos[9]), idT, new Nombre(Tratamiento.valueOf(campos[2]), campos[3], campos[4], campos[5]), dir);
                        else cEmp.hireAuxiliarForEmpresa(Rut.of(campos[9]), idT, new Nombre(Tratamiento.valueOf(campos[2]), campos[3], campos[4], campos[5]), dir);
                        break;
                    case 4: // Terminales
                    ...
                    case 5: // Buses
                        ...
                        break;
                    case 6: // Viajes
                        // Llamamos al controlador de ventas para crear el viaje usando su lógica interna
                        cSVP.createViaje(LocalDate.parse(campos[0], dF), LocalTime.parse(campos[1], tF), Integer.parseInt(campos[2]),
                                Integer.parseInt(campos[3]), campos[4], new IdPersona[]{Rut.of(campos[5]), Rut.of(campos[6])},
                                new String[]{campos[7], campos[8]});
                        break;
                }
            }
        } catch (Exception e) {
    ...
    public static void saveControladores(Object[] data) throws SVPException {
        ...
        } catch (IOException e) { throw new SVPException("Error al guardar objetos"); }
    }
    ...
    public static Object[] readControladores() throws SVPException {
        ...
        } catch (Exception e) { throw new SVPException("Error al leer objetos"); }
    }
